                  ...
                  <div class="row">
                    <table class="table table-hover">
                      ...
                      <tr v-for="item in products">
                        ...
                        <td><img :src="item.type | visual" alt=""></td>
                        <td>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <label class="radio-inline">
                ...
                <img src="/cms/images/area-1.jpg" alt="">
              </label>
              <label class="radio-inline">
                <input type="radio" name="type" value="b" v-model="product.type">
                <img src="/cms/images/area-2.jpg" alt="">
              </label>
              <label class="radio-inline">
                <input type="radio" name="type" value="c" v-model="product.type">
                <img src="/cms/images/area-3.jpg" alt="">
              </label>
              <label class="radio-inline">
                <input type="radio" name="type" value="d" v-model="product.type">
                <img src="/cms/images/area-4.jpg" alt="">
              </label>
            </div>
          </div>
          <div class="form-group">
...
<script>
  ...
  Vue.filter('visual', function (value) {
    ...
    switch (value) {
      case 'a':
        res = '/cms/images/area-1.jpg';
        break;
      case 'b':
        res = '/cms/images/area-2.jpg';
        break;
      case 'c':
        res = '/cms/images/area-3.jpg';
        break;
      case 'd':
        res = '/cms/images/area-4.jpg';
        break;
    }
